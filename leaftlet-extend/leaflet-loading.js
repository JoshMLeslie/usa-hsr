 ...
 *
 * via https://github.com/ebrelsford/Leaflet.loading/tree/master
 */

/**
 * Changed spinJS to spinner for generalization
 */
	...
	L.Control.Loading = L.Control.extend({
		...
		onAdd: function (map) {
			...
			if (this.options.spinner) {
				this._spinner = this.options.spinner; // e.g. SpinnerJS instance
		...
		_countLoaders: function () {
			...
			for (key in this._dataLoaders) {
				if (Object.prototype.hasOwnProperty.call(this._dataLoaders, key)) {
					size++;
				}
			}
			return size;
